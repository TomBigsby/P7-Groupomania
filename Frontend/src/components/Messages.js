...
console.log("datas = "+myDatas[0].postId+" / "+myDatas[0].userId+" / "+myDatas[0].avatarUrl+" / "+myDatas[0].postDate+" / "+myDatas[0].postTitle);
    ...
    return (
        <div className="post-container">
            ...
            <div className="post-publication box">
                ...
                <div className="post-publication-image"><img src="https://picsum.photos/id/1025/500/300" alt="" /></div>
            </div>
                ...
                <div className="post-comment">
                    <div className="post-comment-bloc1">
                        ...
                        <div className="post-comment-bloc1-b">
                            ...
                            <div className="post-comment-date"><span>&nbsp;</span>il y a 30 minutes</div>
